 ...
 */
public class DrawingCanvas_1 extends javax.swing.JPanel  {
    ...
    private static double zoomX;
    private static double zoomY;
    
    private int x1, x2, y1, y2;
    /** Creates new form DrawingCanvas
     * @param parent
     */
    public DrawingCanvas_1(DocumentsHolder parent) {
        this.parent = parent;
        isDragging = false;
    ...
    private void formMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_formMouseMoved
        if(parent.canvasMode == parent.MODE_EDIT){
            ...
            x1 = evt.getX();
            y1 = evt.getY();
            edit_mode = parent.isLocated((int)((x1/zoomX)), (int)((y1/zoomY)));
    ...
    private void formMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_formMouseDragged
        if(parent.canvasMode == parent.MODE_DRAW){
            ...
            parent.changeCurrentObjectsPosition((int)((x-centerX)/zoomX), (int)((y-centerY)/zoomY), (int)(w/zoomX), (int)(h/zoomY));
    ...
    private void formMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_formMouseReleased
        ...
        if(parent.canvasMode == parent.MODE_DRAW){
            ...
            if(w ==0 || h==0) return;
            parent.addObjectToLayer((int)((x-centerX)/zoomX), (int)((y-centerY)/zoomY), (int)(w/zoomX), (int)(h/zoomY));
            repaint();
        } else if(parent.canvasMode == parent.MODE_ZOOM_IN){
    ...
    private void formMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_formMousePressed
        ...
        y1 = evt.getY();
        if(parent.canvasMode == parent.MODE_DRAW){
            parent.createCurrentObject((int)(x1/zoomX), (int)(y1/zoomY), 0, 0);
        } else if(parent.canvasMode == parent.MODE_EDIT){
    ...
    public void paint(Graphics g){
        super.paint(g);
        FsGraphics g2d = new FsGraphics(g);
        ...
        for(i=0; i < this.getWidth(); i+= zoomX){
            for(j=0; j<this.getHeight(); j+= zoomY){
        ...
        if(DocumentsHolder.canvasMode == DocumentsHolder.MODE_DRAW){
            ...
            parent.paintLayers(g2d);
            if(edit_mode != 0)
                selectedObject.paintSelected(g2d, edit_mode, zoomX, zoomY);
        } else if(parent.canvasMode == parent.MODE_ZOOM_IN){
